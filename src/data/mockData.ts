...
export const rentalHistory: Rental[] = [
  ...
  },
  {
    ...
    items: [{ name: "Trekking Shoes", quantity: 1, price_per_unit: 1000 }],
  ...
  },
  {
    ...
    items: [{ name: "Water Bottle (1L)", quantity: 1, price_per_unit: 100 }],
  ...
  },
  {
    ...
    items: [{ name: "Water Bottle (500mL)", quantity: 1, price_per_unit: 70 }],
    rental_start_date: "2024-08-01",
    rental_end_date: "2024-08-05",
    total_price: 100,
    status: "Cancelled",
  },
  {
    order_id: "rental_1005",
    items: [{ name: "Water Bottle (2L)", quantity: 1, price_per_unit: 150 }],
    rental_start_date: "2023-09-01",
    rental_end_date: "2023-09-05",
    total_price: 100,
    status: "Completed",
  },
];
